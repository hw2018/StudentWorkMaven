...
<head>
			...
			$("a[title]").click(function(){
				...
				if($("#tt").tabs("exists", text)) {
					...
					$("#tt").tabs("add",{
						title:text,
						closable:true,
						content:'<iframe title=' + text + ' src=${manager}/' + href + ' frameborder="0" width="100%" height="100%" />'
					});
				}
	...
	<body class="easyui-layout">
	    <div data-options="region:'north',title:'欢迎来到学生事务后台管理',split:true" style="height:100px;"></div>   
