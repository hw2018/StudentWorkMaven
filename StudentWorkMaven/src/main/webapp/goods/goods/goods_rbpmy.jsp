...
function check1()
{
	...
	if(name.value.replace(/^ +| +$/g,"")=="")
		{alert("征购物名不能为空!");return false;}
	else if(price.value.replace(/^ +| +$/g,"")=="")
		{alert("征购价格不能为空!");return false;}
}
...
<br/>
<form method="post" onsubmit="return check2()"action="<%=basePath%>goods/modifygoodsrbp.action">
...
<form name="form1" method="post" onsubmit="return check1()"action="<%=basePath%>goods/addgoodsrbp.action"  style="padding:15px;border:thin dashed black;">
